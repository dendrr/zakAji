window.addEventListener('load', function () {
    var heeader_height = (this.document.getElementsByClassName("wex-category-headerline").clientHeight || 0) +
        this.document.getElementsByClassName("v-header").clientHeight;
    // Вычисление количества одноразок на бекграунде (1 под на 60 пикселей)
    this.alert(this.document.getElementsByClassName("wex-category-headerline").clientHeight || 0);
