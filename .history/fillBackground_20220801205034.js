window.addEventListener('load', function () {
    ...
    pod_quantity = Math.round(pod_quantity / 62.5);
    console.log(pod_quantity);
    ...
    for (let i = 0; i < pod_quantity; i++) {
        ...
        img.style.left = random() * 98 - 1 + "%";        // img.style.left = Math.random() * 100 + "%";
        ...
        // img.style.left = Math.random() * 100 + "%";
        img.style.left = random() * 98 - 1 + "%"; img.style.animationDelay = "-" + Math.random() * 8 + "s"
        var div = document.getElementById("bg_subcont");
        div.appendChild(img);
