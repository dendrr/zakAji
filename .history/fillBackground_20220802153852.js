window.addEventListener('load', function () {
    var heeader_height = this.document.getElementsByClassName("wex-category-headerline") + this.document.getElementsByClassName("v-header");
    ...
    ) - this.document.getElementsByClassName("wex-category-headerline");
    ...
    newDiv.style.height = Math.max(
        ...
        document.body.offsetHeight, document.documentElement.offsetHeight,
        document.body.clientHeight, document.documentElement.clientHeight
    ) - this.document.getElementsByClassName("wex-category-headerline"); // set max height - height of header
