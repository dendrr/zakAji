...
newDiv.id = "bg_subcont";
var clientHeight = document.getElementById('container').clientHeight;

newDiv.style.height = document.getElementsByClassName('product-category-271').clientHeight
document.getElementsByClassName("bg-container").appendChild(newDiv);
